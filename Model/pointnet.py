...
from Model.utils import PointNetSetAbstractionMsg, PointNetFeaturePropagation
...
class SpineSegmentationNet(nn.Module):
    def __init__(self):
        ...
        self.set_abstraction_layer1 = PointNetSetAbstractionMsg(1024, [0.05, 0.1], [16, 32], 9,
                                                                [[16, 16, 32], [32, 32, 64]])
        self.set_abstraction_layer2 = PointNetSetAbstractionMsg(256, [0.1, 0.2], [16, 32], 32 + 64,
                                                                [[64, 64, 128], [64, 96, 128]])
        self.set_abstraction_layer3 = PointNetSetAbstractionMsg(64, [0.2, 0.4], [16, 32], 128 + 128,
                                                                [[128, 196, 256], [128, 196, 256]])
        self.set_abstraction_layer4 = PointNetSetAbstractionMsg(16, [0.4, 0.8], [16, 32], 256 + 256,
